...
describe('parseChangelog', () => {
  ...
  describe('when includePrLinks is true', () => {
    ...
    it('should parse changelog with pull request links within first line of multi-line change description', () => {
      const changelog = parseChangelog({
        changelogContent: outdent`
          # Changelog
          All notable changes to this project will be documented in this file.
    ...
    it('should parse changelog with pull request links within first line of change description with sub-bullets', () => {
      const changelog = parseChangelog({
        changelogContent: outdent`
          # Changelog
          All notable changes to this project will be documented in this file.
  ...
  describe('when includePrLinks is false', () => {
